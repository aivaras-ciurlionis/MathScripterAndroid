...
namespace MathExecutor.Expressions.Equality
{
    ...
    {
        public MemberOfExpression(IExpression leftOperand, IExpression rightOperand) : base(leftOperand, rightOperand)
        {
        }

        public override IExpression Clone()
        {
            return new MemberOfExpression(Operands[0].Clone(), Operands[1].Clone());
        }
