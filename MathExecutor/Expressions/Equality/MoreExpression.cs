...
namespace MathExecutor.Expressions.Equality
{
    ...
    {
        public MoreExpression(IExpression leftOperand, IExpression rightOperand) : base(leftOperand, rightOperand)
        {
        }

        public override IExpression Clone()
        {
            return new MoreExpression(Operands[0].Clone(), Operands[1].Clone());
        }
