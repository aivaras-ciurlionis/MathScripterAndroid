...
namespace MathExecutor.Expressions.Equality
{
    ...
    {
        public EqualityExpression(IExpression leftOperand, IExpression rightOperand, string id = null) 
        ...
        {
            return new EqualityExpression(Operands[0].Clone(changeId), Operands[1].Clone(changeId), changeId ? null : Id);
        }
